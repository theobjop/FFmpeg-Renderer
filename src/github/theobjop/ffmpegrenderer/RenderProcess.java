...
class RenderProcess extends Thread implements Runnable {
	...
	public RenderProcess(String exeloc, String inloc, String outloc) throws Exception {
        ...
        String[] vid = Renderer.getVideoSettings().getRenderSettings();
	...
	// For the testing purposes I'll just do this.
		try {
			...
			ProgressGobbler progGobbler = new ProgressGobbler(process.getErrorStream(), "ERROR", Renderer.getRender().progBar);
			progGobbler.start();
